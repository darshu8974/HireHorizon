    ...
    <AppBar position="sticky" sx={{ backgroundColor: '#2B2118' }}> 
      <Toolbar>
        ...
        >
          ...
          <MenuItem onClick={() => { handleNavigation('/login'); handleMenuClose(); }}>Logout</MenuItem>
          {/* <MenuItem onClick={() => { handleNavigation('/admindashboard'); handleMenuClose(); }}>Admindashboard</MenuItem> */}
        </Menu>
      </Toolbar>
    </AppBar>
  );
